...
export default function LoginPage() {
  ...
  const handleGoogleLogin = () => {
    Swal.fire({
      title: 'Coming Soon! 🚀',
      text: 'Fitur Login Google sedang dikembangkan. Silakan masuk menggunakan Email & Password terlebih dahulu ya!',
      icon: 'info',
  ...
  const handleGithubLogin = () => {
    Swal.fire({
      title: 'Coming Soon! 🚀',
      text: 'Fitur Login GitHub sedang dikembangkan. Silakan masuk menggunakan Email & Password terlebih dahulu ya!',
      icon: 'info',
      confirmButtonText: 'Siap, Mengerti!',
      confirmButtonColor: '#4e73df'
    });
      ...
      <div className="w-full max-w-[420px] bg-white rounded-3xl shadow-xl shadow-slate-200/60 p-8 relative z-10">
        ...
        <form onSubmit={handleLogin} className="space-y-3.5">
          ...
          <div className="text-right">
            <button type="button" className="text-[12px] text-[#3478f6] font-bold hover:underline">
              Lupa password?
            </button>
          </div>
        ...
        <p className="text-center text-[13px] text-[#8696a7] font-medium mt-6">
          ...
          <Link href="/register" className="text-[#3478f6] font-bold hover:underline">Sign up</Link>
        </p>
      </div>
    </main>
  );
